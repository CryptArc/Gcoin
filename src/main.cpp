...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GroestlCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("GroestlCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running GroestlCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("GroestlCoinMiner terminated\n");
        throw;
    }
}
